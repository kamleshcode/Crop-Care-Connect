...
if (!isset($_SESSION['fid'])) {         // condition Check: if session is not set. 
    ...
    die(); // if not set the user is sendback to login page.
}
...
<title>Profile-page-CropCareConnect</title>
    ...
    .profile-card {
        ...
        opacity: 0;
        margin-top: 70px;
        border-radius: 4px; /* Adjusted for responsiveness */
    ...
    .profile-card header a {
        ...
        text-align: center;
        margin: 25px auto; /* Center horizontally for responsiveness */
    }
    ...
    .profile-social-links li {
        display: inline-block;
        margin: 0px 5px; /* Adjusted for spacing */
    }
    ...
    .profile-social-links li a {
        ...
        font-size: 18px;
        color: black;
        background: rgba(255, 255, 255, 0.7); /* Adjusted for visibility */
    ...
    .profile-social-links li a:hover {
        background: rgba(255, 255, 255, 0.9); /* Adjusted for hover visibility */
    }

    .button-88,
    .button-89 {
        width: 100%; /* Adjusted for responsiveness */
        margin: 20px auto; /* Center horizontally for responsiveness */
    }
        @import url("https://fonts.googleapis.com/css2?family=Roboto&display=swap");
...
<body>
    <aside class="profile-card">
        <header>
            ...
            <h2>Mobile-no :-
                <?php echo $_SESSION['fmobile']; ?>
            </h2>
            <h2>total Product You Uploaded :-
                <?php
                $show_products = mysqli_query($conn, "SELECT * FROM `fproduct`where fid='$fid'") or die('query failed');
                $row = mysqli_num_rows($show_products);
                if ($row > 0) {
                    echo $row;
                } else {
        ...
        <ul class="profile-social-links">
            <!-- twitter - el clásico  -->
            <li>
            <button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/weatherio-starter-master/index.html';">Weather-Details</button>

            </li>
            <li>
                  <!-- HTML !-->
<button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/Crop.php';">Crop-Recommendation</button>
</li>
<li>
                  <!-- HTML !-->
<button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/disease.php';">Crop-Disease-Prediction</button>
</li>

            <!-- envato – use this one to link to your marketplace profile -->
            <li>
                                <!-- HTML !-->
<button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/esp-weather-station.php';">Sensor-Details</button>

            </li>

            <!-- codepen - your codepen profile-->
            <li>
            <button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/uploadProduct.php';">Upload-product</button>

            </li>
                
            <li>
            <button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/changePassword.php';"> &nbsp; &nbsp;Change-Password  &nbsp; &nbsp;  </button>

            </li>
            <li>
            <button class="button-88" role="button" onclick="location.href='http://localhost/farmtech-master/update_profile.php';">Update-Profile</button>
