...
export const updateWeather = function (lat, lon) {
  ...
  // container.classList.list.remove("fade-in");
  ...
  fetchData(URL.currentWeather(lat, lon), function (currentWeather) {
    ...
    card.innerHTML = `
        ...
        <ul class="meta-list">
          <li class="meta-item">
            <span class="m-icon">Calender-today</span>
                  ...
                  <div class="highlight-list">
                    ...
                    <div class="card card-sm highlight-card two">
                      ...
                      <div class="card-list">
                        ...
                        <div class="card-item">
                          <span class="m-icon">clear-ight</span>
                          <div>
    ...
    fetchData(URL.forecast(lat, lon), function (forecast) {
      ...
      for (const [index, data] of forecastList.entries()) {
        ...
        tempLi.innerHTML = `
                   ...
                   <div class=card card-sm slider-card>
                     <p class="body-3">
                       ${module.getUTCHours(dateTimeUnix, timezone)}
                     </p>
                     <img class="weather-icon" src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy"
      ...
      for (let i = 7, len = forecastList.length; i < len; i += 8) {
        ...
        li.innerHTML = `
            ...
            <div class="icon-wrapper">
              ...
              <p class="lable-1">${date.getDate()} ${module.monthNames[date.getMonth()]}</p>
              <br>
              <p class="lable-1">${module.weekDayNames[date.getUTCDay()]}</p>
            `;
      ...
      container.computedStyleMap.overflowY = "overlay";
