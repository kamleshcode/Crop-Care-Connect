      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-6">
               ...
               <br>
               <br>
               <div data-aos="zoom-in" class="div" data-aos-duration="2000"><img src="images/img-12.png"
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
               ...
               <div class="footer_links">
                  <ul>
                     <li><a href="pricing page2.php">For Own use</a></li>
                     <li><a href="pricing page2.php">For small Business</a></li>
                     <li><a href="pricing page2.php">Enterprise business</a></li>
                  </ul>
               </div>
            </div>
            <div class="col-lg-3 col-sm-6">
